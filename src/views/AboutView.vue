                    ...
                    children: [
                      {
                        ...
                        name: "子节点1",
                        status: 0,
                        icon: require("../assets/pangxie.png"),
                        fontCss: {
                          fontFamily: "fantasy",
                          color: "red",
                          textDecoration: "line-through",
